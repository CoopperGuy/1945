...
HRESULT CBGuideBullet::Initialize()
{
...
void CBGuideBullet::Late_Update()
{
...
void CBGuideBullet::Render(HDC _DC)
{
	RECT rc = {};
	rc.left = m_vQ[0].x;
	rc.top = m_vQ[0].y;
