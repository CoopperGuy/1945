...
void CStrBullet::Ready()
{
}

int CStrBullet::Update()
{
	if (m_bDead)
		return OBJ_DEAD;
...
void CStrBullet::Render(HDC _DC)
{
	RECT rc = {};
	rc.left = m_vQ[0].x;
	rc.top = m_vQ[0].y;
